...
// Session — UTR pre-registration & managed verification sessions
export { createVerificationSession, extractUtrFromText, extractUtrFromImage, normalizeUtr } from "./session/index.js";
export { InMemoryUtrStore, type UtrStore } from "./session/index.js";
export type {
  VerificationSession,
